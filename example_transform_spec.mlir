...
#rocm_target = #hal.executable.target<"rocm", "rocm-hsaco-fb", {target_arch = "gfx1100", ukernels = "none"}>

module attributes {transform.with_named_sequence} {
  util.func private @argmax_1d_f32_entry_point(%arg0: tensor<1x?xf32>) -> tensor<1xi64> {
      ...
      objects({
        #rocm_target ordinal(0) = [
          #hal.executable.object<{
            path = "/home/stanley/nod/macroHipKernel/argmax_ukernel.c.hsaco"
          }>
        ]
      })
